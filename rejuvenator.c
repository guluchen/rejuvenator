...
*/
/*@ ghost
    int ghost_logical[N_LOG_BLOCKS][N_PAGE];    // logical disk array
...
1. ghost_logical - record data in logical array
...
/*@
    ...
    ensures clean[h_act_block_index_p] == clean[l_act_block_index_p] == false;
...
*/
/*TODO:
1. for all other place in disk / use assign
*/
/*@
...
void write_2_lower_number_list (int d, int lb, int lp) {
    ...
    if (l_act_page_p + 1 == N_PAGE){
        ...
        /*@
            ...
            loop invariant N_PHY_BLOCKS - l_act_block_index_p;
        */
...
void gc (void) {
    ...
    */
    ...
    /* high / low clean counter version
